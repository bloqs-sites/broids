...
public class RealEstateAdapter extends Adapter<RealEstate> {
public static final int LAYOUT = R.layout.real_estate_card;

public RealEstateAdapter(Context ctx, List<RealEstate> list, ActivityProxy proxy) {
...
public ViewHolder<RealEstate> createViewHolder(Context ctx, @NonNull View v) {
	return new RealEstateViewHolder(ctx, v);
}
}
